...
<form>
	...
	<div>
		...
		<div><s:date name="item.listTime" format="yyyy-MM-dd HH:mm"/></div>
	</div>
	<div>
		<label>调整为:</label><br/>
		<input class="text" type="text" name="list_time" value='<s:date name="item.listTime" format="yyyy-MM-dd HH:mm"/>'/>
	</div>
</form>
